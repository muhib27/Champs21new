...
//    public static final String APPS_GAMES = "apps_games";
...
//    public static final String VIDEO = "video";
    ...
    public static final String TERMS_POLICY = "terms_policy";


    public static final int NEWS = 139;
    public static final int SCITECH = 142;
    public static final int APPS_GAMES = 177;
    public static final int CHAMPION = 154;
    public static final int LIFE_STYLE = 133;
    public static final int RESOURCE_CENTER = 144;
