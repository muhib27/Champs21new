...
import com.champs21.schoolapp.adapter.SearchAdapter;
...
//    }
    ...
    public void callNewsApiFirst( String selected) {
        ...
        RetrofitApiClient.getApiInterface().getSearachTopics(selected, currentPage, 0)
...
//    }
    ...
    private void callNewsApiNext( String selected) {
        RetrofitApiClient.getApiInterface().getSearachTopics(selected, currentPage, currentOffst)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<Response<List<CategoryModel>>>() {
                    @Override
